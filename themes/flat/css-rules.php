<?php
	...
	function onp_sl_get_flat_theme_css_rules()
	{
		...
		$result['button_cover_vkontakte_color'] = array(
			array(
				'css' => 'background: {value};',
				'selector' => '.onp-sl-flat .onp-sl-button-vk .onp-sl-overlay-front, .onp-sl-flat .onp-sl-button-vk .onp-sl-overlay-back'
			),
			array(
				'css' => 'border-bottom-color: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-flat .onp-sl-button-vk .onp-sl-overlay-front'
			),
			array(
				'css' => 'background: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-flat .onp-sl-button-vk .onp-sl-overlay-header'
			)
		);

		$result['button_cover_odnoklassniki_color'] = array(
			array(
				'css' => 'background: {value};',
				'selector' => '.onp-sl-flat .onp-sl-button-ok .onp-sl-overlay-front, .onp-sl-flat .onp-sl-button-ok .onp-sl-overlay-back'
			),
			array(
				'css' => 'border-bottom-color: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-flat .onp-sl-button-ok .onp-sl-overlay-front'
			),
			array(
				'css' => 'background: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-flat .onp-sl-button-ok .onp-sl-overlay-header'
			)
		);
