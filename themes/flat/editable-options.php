<?php
	...
	function onp_sl_get_flat_theme_editable_options()
	{
		...
		$lockerButtons[2][0]['items'][0]['items'][] = array(
			'type' => 'color',
			'name' => 'button_cover_vkontakte_color',
			'title' => __('VKontakte cover color', 'bizpanda'),
			'default' => '#64a0bc'
		);

		$lockerButtons[2][0]['items'][0]['items'][] = array(
			'type' => 'color',
			'name' => 'button_cover_odnoklassniki_color',
			'title' => __('Odnoklassniki cover color', 'bizpanda'),
			'default' => '#fe8c19'
		);
