<?php
	...
	function onp_sl_get_secrets_theme_editable_options()
	{
		...
		$lockerContainer = array(
			__('Locker Container', 'bizpanda'),
			'locker-box',
			array(
		...
		$lockerButtons[2][0]['items'][] = array(
			'type' => 'accordion-item',
			'title' => __('Vkontakte Color', 'bizpanda'),
			'items' => array(
				// background options
				array(
					'type' => 'control-group',
					'name' => 'button_vkontakte_substrate',
					'default' => 'gradient',
					'items' => array(
						array(
							'type' => 'control-group-item',
							...
							'items' => array(
								array(
									'type' => 'color-and-opacity',
									'name' => 'button_vkontakte_substrate_color',
									'title' => __('Set up color', 'bizpanda')
								)
							)
						),
						array(
							...
							'items' => array(
								array(
									'type' => 'gradient',
									'name' => 'button_vkontakte_substrate_gradient',
									'title' => __('Set up gradient', 'bizpanda'),
									'default' => '{"filldirection":"top","color_points":["#64a0bc 0% 1","#597a9f 100% 1"]}',
								)
							)
						)
					)
		...
		$lockerButtons[2][0]['items'][] = array(
			'type' => 'accordion-item',
			'title' => __('Odnoklassniki Color', 'bizpanda'),
			'items' => array(
				// background options
				array(
					'type' => 'control-group',
					'name' => 'button_odnoklassniki_substrate',
					'default' => 'gradient',
					'items' => array(
						array(
							'type' => 'control-group-item',
							...
							'items' => array(
								array(
									'type' => 'color-and-opacity',
									'name' => 'button_odnoklassniki_substrate_color',
									'title' => __('Set up color', 'bizpanda')
								)
							)
						),
						array(
							...
							'items' => array(
								array(
									'type' => 'gradient',
									'name' => 'button_odnoklassniki_substrate_gradient',
									'title' => __('Set up gradient', 'bizpanda'),
									'default' => '{"filldirection":"top","color_points":["#fe8c19 0% 1","#e67401 100% 1"]}'
								)
							)
						)
					)
