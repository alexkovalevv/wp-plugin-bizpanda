<?php
	...
	function onp_sl_get_secrets_theme_css_rules()
	{
		...
		$result['button_vkontakte_substrate_color'] = array(
			array(
				'css' => 'background: {value|onp_to_rgba};',
				'selector' => '.onp-sl-secrets .onp-sl-button-vk .onp-sl-overlay-front, .onp-sl-secrets .onp-sl-button-vk .onp-sl-overlay-back'
			),
			array(
				'css' => 'background: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-secrets .onp-sl-button-vk .onp-sl-overlay-header'
			)
		);

		$result['button_vkontakte_substrate_gradient'] = array(
			array(
				'css' => array(
					'background: {value|onp_to_gradient};',
					'background: -webkit-{value|onp_to_gradient};',
		...
		//end background vkontakte

		// background odnoklassniki
		$result['button_odnoklassniki_substrate_color'] = array(
			array(
				'css' => 'background: {value|onp_to_rgba};',
				'selector' => '.onp-sl-secrets .onp-sl-button-ok .onp-sl-overlay-front, .onp-sl-secrets .onp-sl-button-ok .onp-sl-overlay-back'
			),
			array(
				'css' => 'background: {value|onp_smart_blackout_color};',
				'selector' => '.onp-sl-secrets .onp-sl-button-ok .onp-sl-overlay-header'
			)
		);

		$result['button_odnoklassniki_substrate_gradient'] = array(
			array(
				'css' => array(
					'background: {value|onp_to_gradient};',
					'background: -webkit-{value|onp_to_gradient};',
