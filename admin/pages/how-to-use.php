<?php
	 ...
	 * Common Settings
	 */
	class OPanda_HowToUsePage extends FactoryPages000_AdminPage {
		...
		public function assets($scripts, $styles)
		{
			...
			$this->styles->add(OPANDA_BIZPANDA_URL . '/assets/admin/css/howtouse.css');
		...
		protected function getPages()
		{
			...
			if( BizPanda::hasFeature('vk') ) {
				$items[0]['items'][] = array(
					'name' => 'vk-app',
					'title' => __('Creating Vkontakte App', 'bizpanda')
				);
			}
			...
			/*@mix:place*/
			//todo: Фильтр opanda_help_pages устарел
			$items = factory_000_apply_filters_deprecated("opanda_help_pages", array($items), '1.2.4', 'bizpanda_help_pages');
			$this->_pages = apply_filters('bizpanda_help_pages', $items);
		...
		{
			if( isset($_GET['onp_sl_page']) ) {
				return $_GET['onp_sl_page'];
			}
		...
		{
			if( empty($pageName) ) {
				$pageName = $this->_getCurrentPageName();
			}
					...
					<?php if( isset($item['items']) ): ?>
                        <div class="onp-help-nav-subitems">
							<?php foreach($item['items'] as $subItem) {
								$this->_renderNavItem($subItem, $level, $currents);
							} ?>
                        </div>
					<?php endif ?>
                </div>
		...
		public function indexAction()
		{
			...
			add_action('bizpanda_help_page_facebook-app', array($this, 'facebookApp'));
			add_action('bizpanda_help_page_google-client-id', array($this, 'googleClientId'));
			add_action('bizpanda_help_page_vk-app', array($this, 'getVkApp'));
			add_action('bizpanda_help_page_twitter-app', array($this, 'twitterApp'));
			add_action('bizpanda_help_page_linkedin-api-key', array($this, 'linkedinApiKey'));
			add_action('bizpanda_help_page_troubleshooting', array($this, 'troubleshooting'));
            ...
            <div class="wrap factory-bootstrap-000 factory-fontawesome-000">
                ...
                <div class="onp-help-content">
                    <div class="onp-inner-wrap">
						<?php
							//todo: хук является устаревшим opanda_help_page_
							factory_000_do_action_deprecated('opanda_help_page_' . $this->current, array($this), '1.2.4', 'bizpanda_help_page_' . $this->current);
							
							do_action('bizpanda_help_page_' . $this->current, $this);
						?>
                    </div>
                </div>
            </div>
		...
		public function premium()
		{
            ...
            <div class="onp-help-section">
                ...
                We offer you to try the premium version for 7 days absolutely for free. We sure you will love it.', 'bizpanda'), onp_licensing_000_get_purchase_url($this->plugin)) ?>
                    </p>
                    <p>
            ...
            <div class="onp-help-section">
                ...
                <table class="table table-bordered onp-how-comparation">
                    ...
                    <tr>
                        <th></th>
                        <th><?php _e('Free', 'bizpanda'); ?></th>
                        <th class="onp-how-premium"><?php _e('Premium', 'bizpanda'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td class="onp-how-title"><?php _e('Locking via shortcodes', 'bizpanda'); ?></td>
                        <td class="onp-how-yes"><?php _e('yes', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><?php _e('yes', 'bizpanda'); ?></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title"><?php _e('Batch Locks', 'bizpanda'); ?></td>
                        <td class="onp-how-yes"><?php _e('yes', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><?php _e('yes', 'bizpanda'); ?></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title"><a
                                    href="#social-options"><?php _e('Individual settings for each button', 'bizpanda'); ?></a>
                        </td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title"><a
                                    href="#extra-options"><?php _e('Visibility Options', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <td class="onp-how-title"><a href="#extra-options"><?php _e('Advanced Options', 'bizpanda'); ?></a>
                    </td>
                    <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                    <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-group-title"><i
                                    class="fa fa-bullhorn"></i> <?php _e('Social Buttons', 'bizpanda'); ?></td>
                    ...
                    <tr>
                        <td class="onp-how-group-title"><i
                                    class="fa fa-adjust"></i> <?php _e('Overlap Modes', 'bizpanda'); ?></td>
                        <td class="onp-how-yes"></td>
                        <td class="onp-how-yes onp-how-premium"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="onp-how-title"><a href="#blurring"><?php _e('Blurring (new!)', 'bizpanda'); ?></a>
                        </td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-group-title"><i
                                    class="fa fa-picture-o"></i> <?php _e('Themes', 'bizpanda'); ?></td>
                        <td class="onp-how-yes"></td>
                        <td class="onp-how-yes onp-how-premium"></td
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="onp-how-title onp-how-group-in-group"><a
                                    href="#extra-themes"><?php _e('The "Flat" Theme (new!)', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title onp-how-group-in-group"><a
                                    href="#extra-themes"><?php _e('The "Dandyish" Theme', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title onp-how-group-in-group"><a
                                    href="#extra-themes"><?php _e('The "Glass" Theme', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('no', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium"><strong><?php _e('yes', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-group-title"><i
                                    class="fa fa-clock-o"></i> <?php _e('Services', 'bizpanda'); ?></td>
                        <td class="onp-how-yes"></td>
                        <td class="onp-how-yes onp-how-premium"></td
                    </tr>
                    <tr>
                        <td class="onp-how-title onp-how-group-in-group"><a
                                    href="#updates"><?php _e('Updates', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('not guaranteed', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium">
                            <strong><?php _e('primary updates', 'bizpanda'); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="onp-how-title"><a href="#support"><?php _e('Support', 'bizpanda'); ?></a></td>
                        <td class="onp-how-no"><?php _e('not guaranteed', 'bizpanda'); ?></td>
                        <td class="onp-how-yes onp-how-premium">
                            <strong><?php _e('dedicated support', 'bizpanda'); ?></strong></td>
                    </tr>
                    </tbody>
                </table>
				<?php if( !$alreadyActivated ) { ?>
                    <div>
                        <a class="button button-primary" id="activate-trial-btn"
                           href="<?php echo onp_licensing_000_manager_link($this->plugin->pluginName, 'activateTrial', false) ?>">
                            <i class="fa fa-star-o"></i>
							<?php _e('Click Here To Activate Your Free Trial For 7 Days', 'bizpanda'); ?>
                            <i class="fa fa-star-o"></i>
                            <br/>
                            <small><?php _e('(instant activation by a click)', 'bizpanda'); ?></small>
                        </a>
                    </div>
				<?php } else { ?>
                    <div class='factory-bootstrap-000'>
                        <a class="btn btn-gold" id="onp-sl-purchase-btn"
                           href="<?php echo onp_licensing_000_get_purchase_url($this->plugin) ?>">
                            <i class="fa fa-star"></i>
							<?php _e('Purchase Opt-In Panda Premium For $24', 'bizpanda'); ?>
                            <i class="fa fa-star"></i>
                        </a>
                    </div>
				<?php } ?>
            ...
            <div class="onp-help-section">
                <p style="text-align: center;">
                    <a href="<?php echo onp_licensing_000_get_purchase_url($this->plugin) ?>"><strong><?php _e('Or Buy The Opt-In Panda Right Now For $24', 'bizpanda'); ?></strong></a>
                </p>
                <div class="onp-remark">
                    <div class="onp-inner-wrap">
                        ...
                        <p><?php printf(__('<strong>To purchase the Opt-In Panda</strong>, <a target="_blank" href="%s">click here</a> to visit the plugin page on CodeCanyon. Then click the "Purchase" button on the right sidebar.', 'bizpanda'), onp_licensing_000_get_purchase_url($this->plugin)); ?></p>
                    </div>
                </div>
            </div>
		<?php } ?>
            <div class="onp-help-section">
                <p><?php _e('Upgrade To Premium and get all the following features:', 'bizpanda'); ?></p>
            </div>
            ...
            <div class="onp-help-section" id="extra-options">
                ...
                <p><?php _e('Of course, each website has its own unique audience. We know that a good business is an agile business. The premium version of Opt-In Panda provides 8 additional options that allow you to configure the lockers flexibly to meet your needs.', 'bizpanda'); ?></p>
                <p class='onp-img'>
            ...
            <div class="onp-help-section" id='extra-themes'>
                ...
                <p>
                <p><?php _e('The premium version of Opt-In Panda comes with 3 extra impressive, polished styles which create interest and attract attention. They are nicely animated and don\'t look obtrusive:', 'bizpanda'); ?></p>
                <ul>
                    <li><?php _e('<strong>Dandyish</strong>. A very bright theme to attract maximum attention!', 'bizpanda'); ?></li>
                    <li><?php _e('<strong>Flat (new!)</strong>. An extremely awesome theme based on the latest web technologies that will make your site a superstar. It\'s truly fascinating!', 'bizpanda'); ?></li>
                    <li><?php _e('<strong>Glass</strong>. A theme with transparent background which looks good on any website.', 'bizpanda'); ?></li>
                </ul>
                </p>
                <p class='onp-img'>
            ...
            <div class="onp-help-section">
                <p style="text-align: center;">
                    <a href="<?php echo onp_licensing_000_get_purchase_url($this->plugin) ?>"><strong>Or Buy The Opt-In
                            Panda Right Now For $24</strong></a>
                </p>
                <div class="onp-remark">
                    <div class="onp-inner-wrap">
                        <p><?php _e('You can purchase the premium version at any time within your trial period or right now. After purchasing you will get a license key to unlock all the plugin features.', 'bizpanda'); ?></p>
		...
		{
			if( get_locale() == 'ru_RU' ) {
				require OPANDA_BIZPANDA_DIR . '/admin/pages/how-to-use/facebook-app-rus.php';
			} else {
		...
		{
			if( get_locale() == 'ru_RU' ) {
				require OPANDA_BIZPANDA_DIR . '/admin/pages/how-to-use/google-app-rus.php';
			} else {
		...
		/**
		 * Page 'Creating Social Apps' => 'Creating Vkontakte App'
		 *
		 * @since 1.0.0
		 * @return void
		 */
		public function getVkApp()
		{
			require OPANDA_BIZPANDA_DIR . '/admin/pages/how-to-use/vk-app-rus.php';
		}
	...
	FactoryPages000::register($bizpanda, 'OPanda_HowToUsePage');
/*@mix:place*/