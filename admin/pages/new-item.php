<?php
	...
	class OPanda_NewPandaItemPage extends OPanda_AdminPage {
		...
		public function assets($scripts, $styles)
		{
			...
			$this->scripts->add(OPANDA_BIZPANDA_URL . '/assets/admin/js/new-item.js');
			$this->styles->add(OPANDA_BIZPANDA_URL . '/assets/admin/css/new-item.css');
		}
								...
								<div class="postbox opanda-item opanda-item-<?php echo $suggestion['type'] ?>">
									...
									<div class="opanda-buttons">
										<a href='<?php echo $url ?>' class="button button-large" title="<?php _e('Click here to learn more', 'bizpanda') ?>">
											<i class="fa fa-external-link"></i><span><?php _e('Learn More', 'bizpanda'); ?></span>
										</a>
									</div>
								</div>
	...
	FactoryPages000::register($bizpanda, 'OPanda_NewPandaItemPage');