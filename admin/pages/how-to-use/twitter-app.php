<div class="onp-help-section">
	...
	<p><?php _e('On the image below you can see which areas you can change by creating your own app.', 'bizpanda') ?></p>
	...
	<table class="table">
		...
		<tr>
			...
			<td>
				...
				<p>
					<i><?php _e('This application asks your credentials in order to unlock the content. Please read the TOS.', 'bizpanda') ?></i>
				</p>
			</td>
		</tr>
		<tr>
	...
	<table class="table">
		...
		<tr>
			...
			<td>
				...
				<p>
					<i><?php _e('Please enable the permission "Request email addresses from users" for my app. I want to use the option "include_email" while requesting "account/verify_credentials". I ask visitors of my website to sign in by using their Twitter accounts and need to know their emails.', 'bizpanda') ?></i>
				</p>
			</td>
		</tr>
		</tbody>
