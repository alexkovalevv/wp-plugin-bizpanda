<div class="onp-help-section">
	...
	<p><?php _e('If you want to use these buttons, you need to get create a LinkedIn App for your website and generate a Client ID.', 'bizpanda') ?>
		<?php _e('<strong>You don\'t need to do it</strong> if you\'re not going to use these LinkedIn buttons.', 'bizpanda') ?></p>
</div>
<div class="onp-help-section">
	...
	<table class="table">
		...
		<tr>
			...
			<td>
				...
				<p>
					<i><?php _e('This application asks your credentials in order to unlock the content. Please read the Terms of Use to know how these credentials will be used.', 'bizpanda') ?></i>
				</p>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<p>
					<i><?php _e('https://cconp.s3.amazonaws.com/bizpanda/linkedin-app/default-logo.png', 'bizpanda') ?></i>
				</p>
			</td>
		</tr>
		<tr>
...
<div class="onp-help-section">
	<p>
		<?php _e('4. In the field "<strong>Authorized Redirect URLs</strong>" of the section "<strong>OAuth 2.0</strong>" paste the URL:', 'bizpanda') ?>
		<br/>
	</p>
	...
	<p><?php _e('Click the orange button "<strong>Add</strong>", then click the button button "<strong>Update</strong>" below the from.', 'bizpanda') ?></p>
</div>
<div class="onp-help-section">
