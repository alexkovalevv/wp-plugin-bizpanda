<?php
	...
	class OPanda_StatsScreen {
		...
		public function getChart($options)
		{
			...
			return new $this->options['chartClass']($this, $chartData, $options);
		}
		...
		public function getTable($options)
		{
			...
			return new $this->options['tableClass']($this, $tableData, $options);
		}
	}
	...
	class OPanda_StatsChart {
		...
		public function __construct($screen, $data, $options = array())
		{
			$this->screen = $screen;
			$this->data = $data;
			$this->options = $options;
