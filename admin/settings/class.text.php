	...
	class OPanda_TextSettings extends OPanda_Settings {
		...
		public function getOptions()
		{
			...
			$confirmScreenOptions = array(
				'type' => 'form-group',
				'title' => __('The Screen "Please Confirm Your Email"', 'bizpanda'),
			...
			$onestepScreenOptions = array(
				'type' => 'form-group',
				'title' => __('The Screen "One Step To Complete"', 'bizpanda'),
			...
			$miscOptions = array(
				'type' => 'form-group',
				'title' => __('Miscellaneous', 'bizpanda'),
				...
				'items' => array(
					...
					array(
						...
						'hint' => __('Use the tag {timer} to display the number of seconds remaining to unlocking.', 'bizpanda'),
						'cssClass' => 'opanda-width-short'
					),
					array(
						'type' => 'textbox',
			...
			$errosOptions = array(
				...
				'items' => array(
					...
					'res_errors_not_granted' => array(
						...
						'hint' => __('Use the tag {permissions} to show required permissions.', 'bizpanda'),
			...
			//todo: Фильтр opanda_settings_text_optons устарел
			$options = factory_000_apply_filters_deprecated("opanda_settings_text_options", array($options), '1.2.4', "bizpanda_settings_text_options");
			$options = factory_000_apply_filters_deprecated("opanda_settings_text_optons", array($options), '1.2.4', "bizpanda_settings_text_options");
			$options = apply_filters('bizpanda_settings_text_options', $options);
