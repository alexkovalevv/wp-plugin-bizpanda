<?php
	...
	class OPanda_SocialSettings extends OPanda_Settings {
		...
		{
			?>
            <p><?php _e('Set up here your social API keys and app IDs for social buttons.', 'bizpanda') ?></p>
			<?php
		}
		...
		public function getOptions()
		{
			...
			if( BizPanda::hasFeature('vk') ) {
				...
				$options[] = array(
					'type' => 'textbox',
					'name' => 'vk_appid',
					'title' => __('Vkontakte App ID', 'bizpanda'),
					'hint' => sprintf(__('If you want to use the Vk like, share or sign-in buttons you need to <a href="%s" target="_blank">register another app</a> id for your website.', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=vk-app')),
					'after' => sprintf(__('<a href="%s" class="btn btn-default" target="_blank">Register App</a>', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=vk-app'))
				);
				
				$options[] = array(
					'type' => 'textbox',
					'name' => 'vk_app_secret',
					'title' => __('Vkontakte Protected Key', 'bizpanda'),
					'hint' => sprintf(__('If you want to use Vk sign-in buttons you need to <a href="%s" target="_blank">register another app</a> and get the protected key.', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=vk-app')),
					'after' => sprintf(__('<a href="%s" class="btn btn-default" target="_blank">Register App</a>', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=vk-app'))
				);
			...
			$options[] = array(
				...
				'hint' => sprintf(__('By default, the developer app id is set. If you want to use the Facebook Share or Facebook Sign-In buttons you need to <a href="%s" target="_blank">register another app</a> id for your website.', 'bizpanda'), 'http://www.youtube.com/watch?v=rEMc-IewRMo'),
				'after' => sprintf(__('<a href="%s" class="btn btn-default" target="_blank">Register App</a>', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=facebook-app'))
			);
			...
			$options[] = array(
				...
				'after' => sprintf(__('<a href="%s" class="btn btn-default" target="_blank">Register App</a>', 'bizpanda'), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=twitter-app')),
