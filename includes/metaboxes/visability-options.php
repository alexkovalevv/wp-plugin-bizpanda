<?php
	 ...
	 * @since 2.3.0
	 */
	class OPanda_VisabilityOptionsMetaBox extends FactoryMetaboxes000_FormMetabox {
		...
		public function form($form)
		{
			...
			//todo: Фильтр opanda_visability_options устарел
			$options = factory_000_apply_filters_deprecated('opanda_visability_options', array(
				$options,
				$this
			), '1.2.4', 'bizpanda_visability_options');

			$options = apply_filters('bizpanda_visability_options', $options, $this);
		...
		public function htmlReLockOptions()
		{
			...
			?>
			<div class='onp-sl-sub <?php if( !$relock ) {
				echo 'hide';
		...
		public function visibilityFilters()
		{
			...
			//todo: Фильтр bp_visibility_filter_params устарел
			$groupedFilterParams = factory_000_apply_filters_deprecated('bp_visibility_filter_params', array($groupedFilterParams), '1.2.4', 'bizpanda_visibility_filter_params');
			$groupedFilterParams = apply_filters('bizpanda_visibility_filter_params', $groupedFilterParams);
			...
			//todo: Фильтр bp_visibility_templates устарел
			$templates = factory_000_apply_filters_deprecated('bp_visibility_templates', array($templates), '1.2.4', 'bizpanda_visibility_templates');
			$templates = apply_filters('bizpanda_visibility_templates', $templates);
			?>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="bp-filter bp-template">
									...
									<div class="bp-head">
										<div class="bp-left">
											<span style="margin-left: 0px;"><strong><?php _e('Type', 'bizpanda') ?>
													:</strong></span>
								...
								<div class="bp-date-control bp-relative bp-template">
									...
									<div class="bp-switcher">
										<label><input type="radio" checked="checked" value="relative"/>
											<span><?php _e('relative', 'bizpanda') ?></span></label>
										<label><input type="radio" value="absolute"/> </span><?php _e('absolute', 'bizpanda') ?></span>
										</label>
									</div>
								</div>
							</div>
		...
		public function onSavingForm($post_id)
		{
			...
			//todo: хук является устаревшим onp_sl_visability_options_on_save
			factory_000_do_action_deprecated('onp_sl_visability_options_on_save', array($this), '1.2.4', 'bizpanda_visability_options_on_save');

			do_action('bizpanda_visability_options_on_save', $this);
		}
	}
	
	global $bizpanda;
	FactoryMetaboxes000::register('OPanda_VisabilityOptionsMetaBox', $bizpanda);
/*@mix:place*/
